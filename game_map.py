...
objects = {
        ...
        27: [images.map, images.full_shadow, f"The screen says the crash site was Sector: " + str(LANDER_SECTOR) + " // X: {LANDER_X} // Y: {LANDER_Y}" ],
        28: [images.rock_large, images.rock_large_shadow, "A rock. It's coarse surface feels like a whetstone", "the rock"],
        ...
        31: [images.fence, None, "A fine guaze fence. It helps protect the station from dust storms."],
        ...
        36: [images.globe, images.globe_shadow, "A giant globe of the planet. It gently glows from the inside"],
        ...
        47: [images.rocket, images.rocket_shadow, "A 1-person craft inr repair."],
        48: [images.toxic_floor, None, "Toxic floor - do not walk on it!"],
        ...
        79: [images.access_card, None, f"This access card bleongs to {PLAYER_NAME}", "an access card"],
        80: [images.access_card, None, f"This access card bleongs to {FRIEND1_NAME}", "an access card"],
        81: [images.access_card, None, f"This access card bleongs to {FRIEND2_NAME}", "an access card"],
